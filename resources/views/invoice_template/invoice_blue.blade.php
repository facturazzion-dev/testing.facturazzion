    ...
    <section>
        <div class="px-30">
                ...
                <table class="header">
                    <tbody>
                        <td class="col-6 text-left">
                            <strong>Razón Social:</strong> <span>{{ $emisor['Nombre'] }}</span><br>
            ...
            <div>
                ...
                <table class="header">
                    <tbody>
                        <td class="col-6 text-left">
                            @if (isset($model->companies->name))
                            <strong>Nombre Comercial:</strong> <span>{{ $model->companies->name }}</span><br>
                            @endif
                            <strong>Razón Social:</strong> <span>{{ $receptor['Nombre'] ?? '(No se especificó el nombre del receptor)' }}</span><br>
                        ...
                        <td class="col-6 text-left">
                            ...
                            @endif
                            @if (SatDoc::printAddress())
                                <strong>Domicilio:</strong> <span class="org_address">{{ $model->companies->getFullAddress() }}</span></br>
                            @else
                                <strong>Domicilio:</strong> <span class="org_address">{{ $receptor['DomicilioFiscalReceptor'] }}</span></br>
                            @endif
                            @if ('' !== $receptor['ResidenciaFiscal'])
                                <strong>Residencia fiscal:</strong> <span class="org_address">{{ $receptor['ResidenciaFiscal'] }}</span><br>
                            @endif
        ...
        @endforeach
            ...
            <div class="clearfix m-t-2">
                        ...
                        <div class="column col-10">
                            ...
                            <div class="text-left"><strong>Sello SAT: </strong></div>@if (isset($tfd['SelloSAT'])) <div class="text-left sm-txt">{{$tfd['SelloSAT']}}</div>
                                @endif
                            <div class="text-left"><strong>Cadena original SAT:</strong></div>@if (isset($tfd['SourceString'])) <div class="text-left sm-txt">{{chunk_split($tfd['SourceString'], 100)}}</div>
                                @endif
                            <div class="text-left">
                                @if(!empty($selloCancelacion))
            ...
            <div>
                ...
                LA CANTIDAD DE $ {{$comprobante['Total']}} ({{ SatDoc::numToLetras($comprobante['Total'], $comprobante['Moneda']) }}) VALOR DE LAS MERCANCÍAS RECIBIDAS A MI ENTERA

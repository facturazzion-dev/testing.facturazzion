...
<div class="float-right support-text mr-3">
    @if(!$user->inRole('admin'))
        <div class="float-left ml-3 text-center">
        <a href="https://api.whatsapp.com/send?phone=5216641282251&text=Hola!" class="btn btn-success"><i class="fa fa-whatsapp text-white"></i> 6641282251 / WhatsApp</a>            
        </div>
    @else

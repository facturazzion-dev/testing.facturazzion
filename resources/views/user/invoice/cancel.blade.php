...
{{-- Content --}}
@section('content')
  {!! Form::open(['url' => $type . '/' . $invoice->id . '/confirm-cancel', 'method' => 'post', 'class' => 'row mb-2']) !!}
    ...
    <div class="col-12 col-md-4 mt-2">
      <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#cancelModal">Cancelar factura</button>
    </div>
    <!-- Modal -->
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ¿Estás seguro que quieres cancelar esta factura?
          </div>

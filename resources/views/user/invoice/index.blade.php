...
@include('content._partials._modals.modal-welcome-dialog')
@endsection
  ...
  $(function () {
    ...
    if (dtInvoiceTable.length) {
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              var payOption = '',
                ...
                $invoiceCancel = basePath + $invoiceId + '/cancel',
      ...
      sendInvoiceModal.on('show.bs.modal', function (event) {
        ...
        $(this).find('.hidden-document-id').val(invoiceId);

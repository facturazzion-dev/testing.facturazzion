<div class="card">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="form-group required {{ $errors->has('tax') ? 'has-error' : '' }}">
                    {!! Form::label('tax', trans('tax.tax'), ['class' => 'control-label']) !!}
                    <div class="controls">
                        {!! Form::select('tax', array('001'=>'ISR','002'=>'IVA','003'=>'IEPS'),null, ['class' => 'form-control']) !!}

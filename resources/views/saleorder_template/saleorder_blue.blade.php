...
<head>
    ...
    <title>{{ trans('saleorder.saleorder') }}</title>
    <?php
                ...
                <table class="header">
                    <tbody>
                        <td class="col-6 text-left">
                            ...
                            @if (isset($saleorder->add_address))
                            @if ($saleorder->add_address=='true')
                            <strong>Domicilio:</strong> <span class="org_address">{{ $saleorder->full_address }}</span>
                            @endif
                            @endif
                        </td>

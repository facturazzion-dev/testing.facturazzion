...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(\App\Repositories\CClaveProdServRepository::class, \App\Repositories\CClaveProdServRepositoryEloquent::class);
        ...
        $this->app->bind(\App\Repositories\CfdiProfileRepository::class, \App\Repositories\CfdiProfileRepositoryEloquent::class);
        ...
        $this->app->bind(\App\Repositories\CompanyBanksRepository::class, \App\Repositories\CompanyBanksRepositoryEloquent::class);
        $this->app->bind(\App\Repositories\CompanyContactsRepository::class, \App\Repositories\CompanyContactsRepositoryEloquent::class);        
        //:end-bindings:
    }
}

...
class Quotation extends Model
{
    ...
    {
        return $this->belongsToMany(Product::class, 'quotations_products', 'quotation_id', 'product_id')->withPivot('id','quantity', 'price','organization_id','company_id','user_id','sku','discount','total','clave_unidad_sat','unidad_sat','clave_sat','description')->withTimestamps();
    }

    public function taxes()
    {
        return $this->belongsToMany(Tax::class, 'quotations_products_taxes')->withPivot('quotation_id','product_id','organization_id','company_id','user_id', 'tax_id', 'quotation_product_id')->withTimestamps();
    }

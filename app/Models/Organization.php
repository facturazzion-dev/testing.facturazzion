...
class Organization extends Model implements Transformable
{
    ...
    protected $fillable = ['name', 'email', 'phone_number', 'fax', 'logo', 'user_id', 'trial_ends_at', 'generic_trial_plan', 'is_deleted', 'created_by_admin','subscription_type','paybook_live_id_user','paybook_sandbox_id_user'];
    ...
    public function cfdiProfiles()
    {
        return $this->hasMany(CfdiProfile::class);
    }
    ...
    public function getSetting(string $key) {
        $this->organizationSettingsRepository = new OrganizationSettingsRepositoryEloquent(app());
        return $this->organizationSettingsRepository->getKey($key);
    }

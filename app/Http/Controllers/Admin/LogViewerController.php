...
class LogViewerController extends Controller
{
    ...
    public function listLogs(Request $request)
    {
        ...
        return view('admin.log_viewer.logs', compact('headers', 'rows','title'));
    }
    ...
    public function show($date)
    {
        ...
        return view('admin.log_viewer.show', compact('log', 'levels', 'entries','title'));
    }
    ...
    public function showByLevel(Request $request, $date, $level)
    {
        ...
        return view('admin.log_viewer.show', compact('level', 'log', 'query', 'levels', 'entries', 'title'));
    }

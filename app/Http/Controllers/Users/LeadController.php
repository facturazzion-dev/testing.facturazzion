...
class LeadController extends Controller
{
    ...
    public function edit($lead)
    {
        ...
        $cities = $this->cityRepository->getByState($lead->state_id);
    ...
    public function ajaxCityList(Request $request)
    {
        ...
        // return $this->cityRepository->orderBy('name','asc')->findByField('state_id',$request->id)
        // ->pluck('name', 'id')->prepend(trans('lead.select_city'),'');
    }

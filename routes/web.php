...
Route::group(['middleware' => ['sentinel', 'admin', 'userdata', 'xss_protection'], 'namespace' => 'Admin'], function () {
    ...
    Route::group(['prefix' => 'organizations'], function () {
        ...
        Route::get('ajax_state_list', 'OrganizationController@ajaxStateList');
        Route::get('ajax_city_list', 'OrganizationController@ajaxCityList');
    });
...
Route::group(['middleware' => ['sentinel', 'userdata', 'subscription', 'xss_protection'], 'namespace' => 'Users'], function () {
    ...
    Route::get('report/{year_month}/download_pdf', 'ReportController@downloadPdf');
    Route::get('report/{year_month}/download_xls', 'ReportController@downloadXls');
    Route::get('report/{year_month}/ajax_create_pdf', 'ReportController@ajaxCreatePdf');
    ...
    Route::group(['prefix' => 'company'], function () {
        ...
        Route::get('ajax_company_data', 'CompanyController@ajaxCompanyData');
        ...
        Route::post('ajax-store-city', 'CompanyController@postAjaxStoreCity');
        Route::get('download-template', 'CompanyController@downloadExcelTemplate');
        Route::get('{company}/toggle-favorite', 'CompanyController@toggleFavorite');
        Route::post('create', 'CompanyController@ajaxStore');
    });
    ...
    Route::group(['prefix' => 'product'], function () {
        Route::get('clave_sat_data', 'ProductController@clave_sat_data');
        Route::get('clave_unidad_sat_data', 'ProductController@clave_unidad_sat_data');
        Route::get('data', 'ProductController@data');
        Route::get('products_data', 'ProductController@products_data');
        Route::get('products_autocomplete', 'ProductController@products_autocomplete');
        ...
        Route::get('{product}/toggle-favorite', 'ProductController@toggleFavorite');
    });
    Route::resource('product', 'ProductController');

    Route::group(['prefix' => 'tax'], function () {
        Route::get('data', 'TaxController@data');
        Route::get('local_data', 'TaxController@localData');
        Route::get('import', 'TaxController@getImport');
        Route::post('import', 'TaxController@postImport');
        Route::post('ajax-store', 'TaxController@postAjaxStore');
        Route::get('download-template', 'TaxController@downloadExcelTemplate');
        Route::get('{tax}/delete', 'TaxController@delete');
        Route::get('{tax}/show', 'TaxController@show');
        Route::get('{tax}/toggle-favorite', 'TaxController@toggleFavorite');
    });
    Route::resource('tax', 'TaxController');

    Route::group(['prefix' => 'local_tax'], function () {
        Route::get('data', 'LocalTaxController@data');
        Route::get('import', 'LocalTaxController@getImport');
        Route::post('import', 'LocalTaxController@postImport');
        Route::post('ajax-store', 'LocalTaxController@postAjaxStore');
        Route::get('download-template', 'LocalTaxController@downloadExcelTemplate');
        Route::get('{tax}/delete', 'LocalTaxController@delete');
        Route::get('{tax}/show', 'LocalTaxController@show');
    });
    Route::resource('local_tax', 'LocalTaxController');
    ...
    Route::group(['prefix' => 'cfdi_profile'], function () {
        Route::get('data', 'CfdiProfileController@data');
        Route::get('{cfdi_profile}/delete', 'CfdiProfileController@delete');
    });
    Route::resource('cfdi_profile', 'CfdiProfileController');

    Route::group(['prefix' => 'quotation'], function () {
        Route::get('data', 'QuotationController@data');
        Route::post('send_quotation', 'QuotationController@sendQuotation');
        Route::post('preview', 'QuotationController@preview');
        ...
        Route::get('{quotation}/reuse', 'QuotationController@reuse');
        ...
        Route::get('{quotation}/download_pdf', 'QuotationController@downloadPdf');
        //convertions
        Route::get('{quotation}/convert_to_invoice', 'QuotationController@convertToInvoice');
        Route::get('{quotation}/convert_to_saleorder', 'QuotationController@convertToSaleOrder');
        //end of convertions
    ...
    Route::group(['prefix' => 'sales_order'], function () {
        ...
        Route::get('{saleorder}/download_pdf', 'SalesorderController@downloadPdf');      
        //conversions
        Route::get('create_from_quotation/{quotation}', 'SalesorderController@createFromQuotation');
        Route::get('{saleorder}/convert_to_invoice', 'SalesorderController@convertToInvoice');
        //end of conversions
        Route::get('{saleorder}/make_invoice', 'SalesorderController@makeInvoice');
        Route::get('{saleorder}/make_saleorder', 'SalesorderController@makeSaleOrderQuotation');
        ...
        Route::get('draft_saleorders', 'SalesorderController@draftIndex');
    });
    ...
    Route::group(['prefix' => 'invoices_payment_log'], function () {
        ...
        Route::post('send_cfdi', 'InvoicesPaymentController@sendCfdi');
        Route::post('preview', 'InvoicesPaymentController@preview');
        Route::get('pay_invoice/{invoice}', 'InvoicesPaymentController@payInvoice');
        Route::get('{payment}/ajax_create_pdf', 'InvoicesPaymentController@ajaxCreatePdf');
        Route::get('{payment}/print_quot', 'InvoicesPaymentController@printQuot');
        Route::get('{payment}/download_pdf', 'InvoicesPaymentController@downloadPdf');
        Route::get('{payment}/download_xml', 'InvoicesPaymentController@downloadXml');
        Route::get('{payment}/show', 'InvoicesPaymentController@show');
        Route::get('{payment}/edit', 'InvoicesPaymentController@edit');
        Route::get('{payment}/delete', 'InvoicesPaymentController@delete');
        Route::get('{payment}/cancel', 'InvoicesPaymentController@cancel');
        Route::post('{payment}/confirm-cancel', 'InvoicesPaymentController@confirmCancel');
    ...
    Route::group(['prefix' => 'invoice'], function () {
        ...
        Route::post('send_cfdi', 'InvoiceController@sendCfdi');
        Route::get('{invoice}/show', 'InvoiceController@show');
        Route::get('{invoice}/edit', 'InvoiceController@edit');
        Route::get('{invoice}/reuse', 'InvoiceController@reuse');
        Route::post('invoice/{invoice}', 'InvoiceController@update');
        Route::get('{invoice}/cancel', 'InvoiceController@cancel');
        Route::post('{invoice}/confirm-cancel', 'InvoiceController@confirmCancel');
        //conversions
        Route::get('create_from_quotation/{quotation}', 'InvoiceController@createFromQuotation');
        Route::get('create_from_saleorder/{saleorder}', 'InvoiceController@createFromSaleorder');
        //end of conversions
        ...
        Route::get('{invoice}/download_pdf', 'InvoiceController@downloadPdf');
        Route::get('{invoice}/download_xml', 'InvoiceController@downloadXml');
        Route::get('{invoice}/preview/{template}/{color}', [
                                                      'as' => 'invoice.preview',
                                                      'uses' => 'InvoiceController@previewInvoice',
                                                  ]
        );

        Route::get('draft_invoices_list', 'InvoiceController@draftInvoices');
        Route::get('draft_invoices', 'InvoiceController@draftIndex');
    });
